...
public class BubbleFactory {
    public static Bubble[] initializeBubbles(int difficulty){
        ...
        if (difficulty == 0){
            bubbles[0] = new Bubble(95 * 3, 45 * 3, speedMultiplier, Bubble.base_speedsY[Bubble.S], Bubble.XL);
            bubbles[1] = new Bubble(290 * 3, 45 * 3, speedMultiplier, Bubble.base_speedsY[Bubble.S], Bubble.M);
        }else{
            if(difficulty == 1){
            speedMultiplier = 1.5;
